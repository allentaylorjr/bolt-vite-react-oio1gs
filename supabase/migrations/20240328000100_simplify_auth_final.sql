...
DROP POLICY IF EXISTS "public_select" ON public.churches;
DROP POLICY IF EXISTS "public_insert" ON public.churches;
DROP POLICY IF EXISTS "public_update" ON public.churches;
