...
DROP POLICY IF EXISTS "allow_insert_for_all" ON public.churches;
DROP POLICY IF EXISTS "allow_select_for_all" ON public.churches;
DROP POLICY IF EXISTS "allow_update_for_owner" ON public.churches;
